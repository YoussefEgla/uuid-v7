...
- 🎯 Entry points to execute your program using `python -m <uuid_v7>` or `$ uuid_v7` with basic CLI argument parsing.
...
Awesome uuid_v7 created by YoussefEgla
...
```py
from uuid_v7 import BaseClass
from uuid_v7 import base_function
